...
if(isset($_POST['email'])){
   ...
   if((filter_var($emailS,FILTER_VALIDATE_EMAIL)==false) || ($emailS != $email)){
      $successfull=false;
      $_SESSION['error_email'] = "Adres jest niepoprawny";  
   }
   ...
   if($password_1!=$password_2){
      $successfull=false;
      $_SESSION['error_password_2'] = "Hasła muszą być identyczne";
   }
   ...
   if(!isset($_POST['policy'])){
      $successfull=false;
      $_SESSION['error_policy'] = "Wymagana akceptacja regulaminu";
   }  

   $private_key = "6Lex9gMaAAAAAEtvjfsdhUqucCw4Y-vyGeBL9cBA";
   $url = 'https://www.google.com/recaptcha/api/siteverify';
    ...
    if(isset($_POST['submit'])){
       ...
       if(!$response->success ==1){
          $_SESSION['error_bot']="reCAPTCHA wymagany";
       }
    }
   ...
   if (isset($_POST['policy'])) $_SESSION['fr_policy'] = true;
   ...
   try{
      ...
      if($connection->connect_error!=0){
         ...
         if($username_number>0){
            $successfull=false;
            $_SESSION['error_username'] = 'Użytkownik o takiej nazwie już istnieje';
         }
         ...
         <div id="form">
           ...
           <div>
            ...
            if (isset($_SESSION['fr_haslo2'])){
              ...
              <label>
             <input type = "checkbox" name = "policy" <?php
            if (isset($_SESSION['fr_policy'])){
             ...
             <?php
              if (isset($_SESSION['error_policy'])){
                 echo '<div class="error">'.$_SESSION['error_policy'].'</div>';
                 unset($_SESSION['error_policy']);
              }
              ?>
              <br><br>
              <center>          
                  <div id = "g-recaptcha" class="g-recaptcha" data-sitekey="6Lex9gMaAAAAAAR0RGJfWTMDL4_53LarsYZ8p10m" ></div>
               </center>
            <?php
