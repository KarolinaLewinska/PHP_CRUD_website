...
<html>
  ...
  <body>
    ...
    <br><br><br><br>
    <div>
      <h2 class="text-center">Dodawanie danych pracownika</h2>
    </div><br>
      ...
      <form class="form-horizontal" action="db/addData.php" method="POST">
        ...
        <div class="form-group">
          ...
          <div style="width:20%">
            ...
            required
            pattern="([a-z0-9!#$%&'\*\\\\+\\/=?^`{}|]{1}[a-z0-9!#$%&'\*\.\\\+\-\/=?^_`{}|]+@[a-z0-9.-]+\.[a-z]{2,4}$)"
            title="Adres e-mail musi składać się tylko z małych liter, musi zawierać znak @ oraz . i nie może rozpoczynać się: . _ -">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <button style="width:20%" type="submit" class="btn btn-secondary" name="dodaj" value="dodaj">DODAJ</button>
        </div>
      </form>
    </div>
    </br>
